   ...
   <?php echo form_open('login/verifylogin'); ?>
     <table width="302" height="160" border="0" align="center" cellpadding="0" cellspacing="0" id="logon">
      ...
      <tr>
        ...
        <tr>
          <td height="40" colspan="2" align="center" bordercolor="#FFFFFF" bgcolor="#999999"><strong style="color:#FFF; font-weight:bold">LOGIN DE USU&Aacute;RIO</strong></td>
        </tr>
		 <tr>
          <td height="19" colspan="2" bordercolor="#CCCCCC" bgcolor="#CCCCCC">&nbsp;</td>
        </tr>
		<tr>
          <td width="132" height="32" align="left" bordercolor="#CCCCCC" bgcolor="#CCCCCC"><strong> Digite  seu CPF:</strong></td>
          <td width="163" align="left" border="#CCCCCC" bgcolor="#CCCCCC"><label>
            <input name="cpf" type="text" id="cpf" maxlength="11"/>
          </label></td>
        </tr>
        <tr>
          <td width="132" height="32" align="left" bordercolor="#CCCCCC" bgcolor="#CCCCCC"><strong> Digite  sua Senha:</strong></td>
          <td width="163" align="left" bordercolor="#CCCCCC" bgcolor="#CCCCCC"><label>
