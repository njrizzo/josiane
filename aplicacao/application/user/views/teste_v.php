...
<head>
	...
	function busca_produtos(codigo){
 
      document.location=('carregaturma/'+codigo ); 
...
<div id="container">
	...
	<select name="codserv" id="codserv" onchange='busca_produtos($(this).val())'>
				 <option value='' >----selecione----</option>
<?php
 
foreach ($servs as $i => $nome)
   echo '<option value="',$i,'" if ($(this).val()==$i){ echo SELECTED;}>',$nome,'</option>';
?>
