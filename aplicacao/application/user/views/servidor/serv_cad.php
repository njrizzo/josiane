...
echo form_open('cadastro/cadastrar');
...
?>
            <h1 align="center" ><font color="#00009C">Por favor preencha os dados abaixo para se cadastrar no SICAP  </font>   </h1>
...
<table width="472" border="0" id="logon">
  <tr>
    ...
    <td colspan="3">
        ...
        <input name="nomeserv" type="text" value="<?php echo set_value('nomeserv'); ?>"  id="nomeserv" size="55" placeholder="nome completo"/>
...
<input type="radio" name="sexo" value="feminino" <?php echo set_radio('sexo', 'feminino'); ?> />Feminino
  ...
  <tr>
	 <td height="25"><font color="red"  >*</font>Identidade: </td>
	 
    <td>
		
		 <?php echo form_error('rgl'); ?>
   <input name="rgl" type="text" value="<?php echo set_value('rgl'); ?>" id="rgl" size="10" placeholder="xxxxxxxxx"/>
  
   
 <td><font color="red"  >*</font>CPF:</td>
    <td>
		<?php echo form_error('cpfl'); ?>
      <input name="cpfl" type="text" value="<?php echo set_value('cpfl'); ?>"  id="cpfl" size="10" placeholder="xxxxxxxxxxx"/>
      <br />
  ...
  <tr>
    <td height="25"  >Nacilonalidade:<br></td>
    
    <td>
		<?php echo form_error('nacilonalidade'); ?>
      <input name="nacilonalidade" type="text" value="<?php echo set_value('nacilonalidade'); ?>" id="nacilonalidade" placeholder="país" >
   ...
   <tr>
    ...
    <td>
      ...
      <option value="casado(a)" <?php echo set_select('estcivil','casado(a)'); ?> >Casado(a)</option>
      <option value="divorciado(a)" <?php echo set_select('estcivil','divorciado(a)'); ?>>Divorciado(a)</option>
      <option value="vi&uacute;vo(a)" <?php echo set_select('estcivil','viúvo(a)'); ?>>Vi&uacute;vo(a)</option>
    </select>
     </td>
 ...
 <td>
  ...
  <tr>
    ...
    <td height="25"  >Endere&ccedil;o - Rua:</td>
    <td width="361">
		<?php echo form_error('endereco'); ?>
        <input name="endereco" type="text" value="<?php echo set_value('endereco'); ?>" id="endereco" placeholder=" Rua x" />
    ...
    <td width="361">
        ...
        <input name="numcasa" type="text" value="<?php echo set_value('numcasa'); ?>" id="numcasa" size="5" placeholder=" xx" />
        
    </td>
  </tr>
  <tr>
	  
    <td width="101" height="30" >Bairro:</td>
    <td width="361">
		<?php echo form_error('bairro'); ?>
        <input name="bairro" type="text" value="<?php echo set_value('bairro'); ?>"  id="bairro"  placeholder="nome do bairro"/>
    ...
    <td width="361">
        ...
        <input name="cidade" type="text" value="<?php echo set_value('cidade'); ?>"  id="cidade" placeholder="nome da cidade"/>
        
    </td>
  </tr>
  <tr>
	  
    <td width="101" height="30" >Complemento:</td>
    <td width="361">
		<?php echo form_error('complemento'); ?>
        <input name="complemento" type="text" value="<?php echo set_value('complemento'); ?>"  id="complemento" size="5"  placeholder="ap. x"/>
...
<option value="TO" <?php echo set_select('estado','TO'); ?>>TO</option>
   ...
   <tr>
    ...
    <td width="101" height="25"  ><font color="red">*</font>CEP:</td>
    <td width="361">
		<?php echo form_error('cep'); ?>
        <input name="cep" type="text" value="<?php echo set_value('cep'); ?>"  id="cep" size="10" placeholder="xxxxxxxx"/>
    ...
    <td width="361">
        ...
        <input name="email" type="text" value="<?php echo set_value('email'); ?>"  id="email" placeholder="email@email.com" />
        
    </td>
  </tr>
   <tr>
	  
    <td width="101" height="25"  ><font color="red"></font>Telefone:</td>
    <td width="361">
		<?php echo form_error('telcontato'); ?>
        <input name="telcontato" type="text" value="<?php echo set_value('telcontato'); ?>"  id="telcontato" size="10" placeholder="xx-xxxxxxxxx" />
        
    </td>
    
     <td width="101" height="25"  ><font color="red"></font>Telefone para Recado:</td>
    <td width="361">
		<?php echo form_error('telcontato2'); ?>
        <input name="telcontato2" type="text" value="<?php echo set_value('telcontato2'); ?>"  id="telcontato2" size="10" placeholder="xx-xxxxxxxxx"/>
       </tr>
       <tr>
    ...
    <td width="101"  ><font color="red">*</font>SIAPE:</td>
    <td width="361">
		<?php echo form_error('siape'); ?>
       <input name="siape" type="text" value="<?php echo set_value('siape'); ?>" id="siape" size="10" placeholder="xxxxx">
       
     </td>
  </tr>
   <tr>
	  
    <td width="101" height="25"  >Unidade:</td>
    <td width="361">
		<?php echo form_error('unidade'); ?>
        <input name="unidade" type="text" value="<?php echo set_value('unidade'); ?>" id="unidade" placeholder="unidade" />
    ...
    <td width="361">
        ...
        <input name="setor" type="text" value="<?php echo set_value('setor'); ?>"  id="setor" placeholder="setor"  />
        
    </td>
  </tr>
   <tr>
	  
    <td width="101" height="25" >Fun&ccedil;&atilde;o:</td>
    <td width="361">
		<?php echo form_error('funcao'); ?>
        <input name="funcao" type="text" value="<?php echo set_value('funcao'); ?>"  id="funcao" placeholder="fun&ccedil;&atilde;o" />
    ...
    <td width="361">
        ...
        <input name="cargo" type="text" value="<?php echo set_value('cargo'); ?>"  id="cargo" placeholder="cargo" />
        
    </td>
  </tr>
     <tr>
	  
    <td width="101" height="25"  >Nome do Chefe:</td>
    <td width="361">
		<?php echo form_error('nomechefe'); ?>
        <input name="nomechefe" type="text" value="<?php echo set_value('nomechefe'); ?>"  id="nomechefe"  placeholder="nome completo"/>
    ...
    <td width="361">
        ...
        <input name="emailchefe" type="text" value="<?php echo set_value('emailchefe'); ?>" id="emailchefe" placeholder="email@email.com" />
    ...
    <td width="101" height="25"  ><font color="red"></font>Telefone do chefe:</td>
    <td width="361">
		<?php echo form_error('telchefe'); ?>
        <input name="telchefe" type="text" value="<?php echo set_value('telchefe'); ?>"  id="telchefe" size="10" placeholder="xx-xxxxxxxxx"/>
        
    </td>
     <td ><font color="red"  >*</font> Siape do Chefe: </td>
     <td> <?php echo form_error('siapechefe'); ?>

        <input name="siapechefe" type="text" value="<?php echo set_value('siapechefe'); ?>"  id="siapechefe" size="6" placeholder="xxxxxxxx"/></td>

  </tr>
   <tr>
	  
    <td width="101" height="25"  >Senha:</td>
    <td width="361">
		<?php echo form_error('senha'); ?>
        <input name="senha" type="password" value="<?php echo set_value('senha'); ?>"  id="senha" size="10" placeholder="xxxxxxxxx"/>
        
    </td>
     <td  > Repita a senha: </td>
     <td> <?php echo form_error('repetesenha'); ?>
        <input name="repetesenha" type="password" value="<?php echo set_value('repetesenha'); ?>"  id="repetesenha" size="10" placeholder="xxxxxxxxx"/></td>
  </tr>
  <tr>
	  <tr>
	  
    <td width="101" height="25"  >Lembrete de Senha:</td>
    <td width="361" colspan="2">
		<?php echo form_error('lembrasenha'); ?>
        <input name="lembrasenha" type="text" value="<?php echo set_value('lembrasenha'); ?>"  id="lembrasenha"  placeholder="Palavra ou Frase "/>
        
    </td>
     <td ><span><font color="red">*</font>Digite somente n&uacute;meros.</span><br><span><font color="red">*</font>A senha deve conter de 6 a 10 dígitos.</span>   </td>
     <td> </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
