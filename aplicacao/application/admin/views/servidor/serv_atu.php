...
<option value="TO" <?= $query->estado=='TO'? 'selected':'';?><?php echo set_select('estado','TO'); ?>>TO</option>
   ...
   <tr>
    ...
    <td width="361">
        ...
        <input name="telcontato2" type="text" value="<?php echo set_value('telcontato2',$query->telcontato2); ?>"  id="telcontato2" size="10" placeholder="xx-xxxxxxxxx"/>
       </tr>
       <tr>
		     <td width="101" height="25"  >Rede social:</td>
    <td width="361">
		<?php echo form_error('redesocial'); ?>
        <input name="redesocial" type="text" value="<?php echo set_value('redesocial',$query->redesocial); ?>"  id="redesocial"  placeholder="Facebook, Twitter, Skype"/>
