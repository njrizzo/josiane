...
<option value="<?=$query->estado ?>" <?php echo set_select('estado','$query->estado',$query->estado); ?>  ><?=$query->estado ?></option>
   ...
   <tr>
    ...
    <td width="361">
        ...
        <input name="telcontato2" type="text" value="<?php echo set_value('telcontato2',$query->telcontato2); ?>"  id="telcontato2" size="10" disabled />
       </tr>
       <tr>
		     <td width="101" height="25"  >Rede social:</td>
    <td width="361">
		<?php echo form_error('redesocial'); ?>
        <input name="redesocial" type="text" value="<?php echo set_value('redesocial',$query->redesocial); ?>"  id="redesocial"  disabled />
   ...
   <tr>
    ...
    <td width="361">
     ...
     <td> <input name="lembrasenha" type="text" value="<?php echo set_value('lembrasenha',$query->lembrasenha); ?>"  id="lembrasenha"  disabled /></td>
  </tr>
